...
trait BatteryServiceFs2GrpcTrailers[F[_], A] {
  ...
  def getLatestBattery(request: pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest, ctx: A): F[(pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryResponse, _root_.io.grpc.Metadata)]
}

object BatteryServiceFs2GrpcTrailers extends _root_.fs2.grpc.GeneratedCompanion[BatteryServiceFs2GrpcTrailers] {
  ...
  def mkClientFull[F[_], G[_]: _root_.cats.effect.Async, A](
    ...
    def getLatestBattery(request: pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest, ctx: A): F[(pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryResponse, _root_.io.grpc.Metadata)] =
      clientAspect.visitUnaryToUnaryCallTrailers[pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest, pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryResponse](
        ...
        request,
        (req, m) => _root_.fs2.grpc.client.Fs2ClientCall[G](channel, pccs.vehiclestates.services.battery.v1.battery_service.BatteryServiceGrpc.METHOD_GET_LATEST_BATTERY, dispatcher, clientOptions).flatMap(_.unaryToUnaryCallTrailers(req, m))
      )
  }
  ...
  protected def serviceBindingFull[F[_], G[_]: _root_.cats.effect.Async, A](
    ...
    _root_.io.grpc.ServerServiceDefinition
      ...
      .addMethod(
        ...
        _root_.fs2.grpc.server.Fs2ServerCallHandler[G](dispatcher, serverOptions).unaryToUnaryCallTrailers[pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest, pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryResponse]{ (r, m) => 
          serviceAspect.visitUnaryToUnaryCallTrailers[pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest, pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryResponse](
