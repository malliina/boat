...
final case class TimeZone(
  ...
  with scalapb.lenses.Updatable[TimeZone]:
  @transient
  ...
  def withId(__v: _root_.scala.Predef.String): TimeZone = copy(id = __v)
  ...
  def companion: pccs.chronos.entities.common.v1.chronos_common.TimeZone.type =
    pccs.chronos.entities.common.v1.chronos_common.TimeZone
  // @@protoc_insertion_point(GeneratedMessage[pccs.chronos.entities.common.v1.TimeZone])
...
object TimeZone
  ...
  implicit def messageCompanion
    : scalapb.GeneratedMessageCompanion[pccs.chronos.entities.common.v1.chronos_common.TimeZone] =
    this
  def parseFrom(
  ...
  implicit def messageReads
    : _root_.scalapb.descriptors.Reads[pccs.chronos.entities.common.v1.chronos_common.TimeZone] =
  ...
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    pccs.chronos.entities.common.v1.chronos_common.ChronosCommonProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = pccs.chronos.entities.common.v1.chronos_common.TimeZone(
    id = ""
  )
  implicit class TimeZoneLens[UpperPB](
    _l: _root_.scalapb.lenses.Lens[UpperPB, pccs.chronos.entities.common.v1.chronos_common.TimeZone]
  ...
  def of(
    id: _root_.scala.Predef.String
  ): _root_.pccs.chronos.entities.common.v1.chronos_common.TimeZone =
    _root_.pccs.chronos.entities.common.v1.chronos_common.TimeZone(
      id
    )
  // @@protoc_insertion_point(GeneratedMessageCompanion[pccs.chronos.entities.common.v1.TimeZone])
