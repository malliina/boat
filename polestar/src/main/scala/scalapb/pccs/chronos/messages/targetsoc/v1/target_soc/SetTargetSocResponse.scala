...
final case class SetTargetSocResponse(
  ...
  with scalapb.lenses.Updatable[SetTargetSocResponse]:
  @transient
  ...
  def companion: pccs.chronos.messages.targetsoc.v1.target_soc.SetTargetSocResponse.type =
...
object SetTargetSocResponse
  ...
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    pccs.chronos.messages.targetsoc.v1.target_soc.TargetSocProto.scalaDescriptor.messages(4)
  ...
  implicit class SetTargetSocResponseLens[UpperPB](
  ...
  def of(
    id: _root_.scala.Predef.String
  ): _root_.pccs.chronos.messages.targetsoc.v1.target_soc.SetTargetSocResponse =
    _root_.pccs.chronos.messages.targetsoc.v1.target_soc.SetTargetSocResponse(
      id
    )
