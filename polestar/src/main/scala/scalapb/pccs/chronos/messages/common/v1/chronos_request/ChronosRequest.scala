...
final case class ChronosRequest(
  ...
  with scalapb.lenses.Updatable[ChronosRequest]:
  @transient
  ...
  def getTimeZone: pccs.chronos.entities.common.v1.chronos_common.TimeZone =
    timeZone.getOrElse(pccs.chronos.entities.common.v1.chronos_common.TimeZone.defaultInstance)
  def clearTimeZone: ChronosRequest = copy(timeZone = _root_.scala.None)
  def withTimeZone(__v: pccs.chronos.entities.common.v1.chronos_common.TimeZone): ChronosRequest =
    copy(timeZone = Option(__v))
  ...
  def companion: pccs.chronos.messages.common.v1.chronos_request.ChronosRequest.type =
...
object ChronosRequest
  ...
  def parseFrom(
    ...
    var __timeZone: _root_.scala.Option[pccs.chronos.entities.common.v1.chronos_common.TimeZone] =
      _root_.scala.None
    ...
    while !_done__ do
      ...
      _tag__ match
        ...
        case 34 =>
          __timeZone = _root_.scala.Option(
            __timeZone.fold(
              _root_.scalapb.LiteParser
                .readMessage[pccs.chronos.entities.common.v1.chronos_common.TimeZone](_input__)
    ...
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pccs.chronos.messages.common.v1.chronos_request.ChronosRequest(
        ...
        source = __fieldsMap
          ...
          .map(_.as[_root_.scala.Predef.String])
          .getOrElse(""),
        timeZone = __fieldsMap
          .get(scalaDescriptor.findFieldByNumber(4).get)
          .flatMap(
            _.as[_root_.scala.Option[pccs.chronos.entities.common.v1.chronos_common.TimeZone]]
          )
      )
  ...
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    pccs.chronos.messages.common.v1.chronos_request.ChronosRequestProto.scalaDescriptor.messages(0)
  ...
  implicit class ChronosRequestLens[UpperPB](
    ...
    def timeZone: _root_.scalapb.lenses.Lens[
      UpperPB,
      pccs.chronos.entities.common.v1.chronos_common.TimeZone
    ] = field(_.getTimeZone)((c_, f_) => c_.copy(timeZone = _root_.scala.Option(f_)))
    def optionalTimeZone: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[
      pccs.chronos.entities.common.v1.chronos_common.TimeZone
    ]] = field(_.timeZone)((c_, f_) => c_.copy(timeZone = f_))
  ...
  def of(
    ...
    source: _root_.scala.Predef.String,
    timeZone: _root_.scala.Option[pccs.chronos.entities.common.v1.chronos_common.TimeZone]
  ): _root_.pccs.chronos.messages.common.v1.chronos_request.ChronosRequest =
    _root_.pccs.chronos.messages.common.v1.chronos_request.ChronosRequest(
      id,
      vin,
      source,
