...
final case class GetBatteryRequest(
  ...
  with scalapb.lenses.Updatable[GetBatteryRequest]:
  @transient
  ...
  def companion: pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest.type =
...
object GetBatteryRequest
  ...
  implicit class GetBatteryRequestLens[UpperPB](
  ...
  def of(
    id: _root_.scala.Predef.String,
    vin: _root_.scala.Predef.String
  ): _root_.pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest =
    _root_.pccs.vehiclestates.services.battery.v1.battery_service.GetBatteryRequest(
      id,
      vin
    )
