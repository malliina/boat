...
final case class Timestamp(
  ...
  with scalapb.lenses.Updatable[Timestamp]:
  @transient
  ...
  def companion: pccs.vehiclestates.entities.common.v1.common.Timestamp.type =
...
object Timestamp
  extends scalapb.GeneratedMessageCompanion[pccs.vehiclestates.entities.common.v1.common.Timestamp]:
  implicit def messageCompanion
    : scalapb.GeneratedMessageCompanion[pccs.vehiclestates.entities.common.v1.common.Timestamp] =
    this
  def parseFrom(
  ...
  implicit def messageReads
    : _root_.scalapb.descriptors.Reads[pccs.vehiclestates.entities.common.v1.common.Timestamp] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    pccs.vehiclestates.entities.common.v1.common.CommonProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    pccs.vehiclestates.entities.common.v1.common.CommonProto.scalaDescriptor.messages(0)
  ...
  implicit class TimestampLens[UpperPB](
    _l: _root_.scalapb.lenses.Lens[UpperPB, pccs.vehiclestates.entities.common.v1.common.Timestamp]
    ...
    def nanos: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] =
      field(_.nanos)((c_, f_) => c_.copy(nanos = f_))
  final val SECONDS_FIELD_NUMBER = 1
  final val NANOS_FIELD_NUMBER = 2
  def of(
    seconds: _root_.scala.Long,
    nanos: _root_.scala.Int
  ): _root_.pccs.vehiclestates.entities.common.v1.common.Timestamp =
    _root_.pccs.vehiclestates.entities.common.v1.common.Timestamp(
      seconds,
      nanos
    )
